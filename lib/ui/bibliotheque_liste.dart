...
import '../bloc/BibliothequeBloc.dart';
...
class BibliothequeList extends StatefulWidget {
  const BibliothequeList({Key? key}) : super(key: key);

  @override
  State<BibliothequeList> createState() => _BibliothequeListState();
}

class _BibliothequeListState extends State<BibliothequeList>
      ...
      return snapshot.data!.isNotEmpty
                                ...
                                onPressed: () {
                                  setState(() {
                                    ...
                                    txtDateAchat.text = snapshot.data![index]
                                            ['dateAchat']
                                        .toString();
                                    ouvrageISBN = snapshot.data![index]['isbn']
                                        .toString();
                                    ouvrageTitre = snapshot.data![index]
                                            ['titre']
                                        .toString();
          ...
          : Expanded(
              child: Column(
                ...
                children: [
                  const Text("Aucune bibliothèque n'a encore été ajouté",
                      style: TextStyle(
                        fontSize: 20,
                  ...
                  Text(
                    "Cliquez sur le bouton du bas pour ajouter une bibliothèque",
